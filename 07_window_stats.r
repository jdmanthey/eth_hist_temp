	options(scipen=999)
	project_directory <- "/lustre/scratch/jmanthey/07_ethiopia_historical/cos_sem/06_window_stats"
	...
	ref_index <- read.table("GCF_003957565.2_bTaeGut1.4.pri_genomic.fna.fai", stringsAsFactors=F)
	...
	header <- paste('\tgunzip -cd ', project_directory, '/NC_054767.1.recode.vcf.gz | grep "#" > ', project_directory, "/windows/${chrom_array}__${start_array}__${end_array}.recode.vcf", sep="")
